...
public class ArticleEditController implements Initializable {
    ...
    public void handleValiderButtonAction(ActionEvent actionEvent) {
        ...
        updateArticle();
        articleService.update(article); // Assuming you have the update method in your ProducerService implementation
